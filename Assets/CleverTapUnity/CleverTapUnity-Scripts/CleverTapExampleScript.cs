...
public class CleverTapExampleScript : MonoBehaviour
{

    public String CLEVERTAP_ACCOUNT_ID = "65R-W6K-KW6Z";
    public String CLEVERTAP_ACCOUNT_TOKEN = "360-256";
    public int CLEVERTAP_DEBUG_LEVEL = 1;

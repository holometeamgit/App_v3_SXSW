...
namespace NatMic {
    ...
    public abstract class AudioDevice : IAudioDevice, IEquatable<AudioDevice> {
        ...
        /// <returns>Was recording started successfully</returns>
        [Doc(@"StartRecording")]
        public abstract bool StartRecording (int requestedSampleRate, int requestedChannelCount, IAudioProcessor processor);

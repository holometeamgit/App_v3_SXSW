...
namespace NatMic.Internal {
    ...
    public static class AudioDeviceBridge {
        ...
        public static extern bool StartRecording (this IntPtr device, int sampleRate, int channelCount, SampleBufferCallback callback, IntPtr context);
        ...
        public static bool DeviceEchoCancellation (this IntPtr device) => false;
        public static bool IsRecording (this IntPtr device) => false;
        public static bool StartRecording (this IntPtr device, int sampleRate, int channelCount, SampleBufferCallback callback, IntPtr context) => false;

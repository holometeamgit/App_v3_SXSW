...
public class PnlContentOptionMenu : MonoBehaviour
{
    ...
    public void FlagPerformance() {
        pnlGenericError.ActivateSingleButton("Flag performance",
            ...
            onBackPress: () => pnlGenericError.gameObject.SetActive(false));
    }

    public void DeletePerformance() {
        pnlGenericError.ActivateDoubleButton("Disconnect from live stream?", "Closing this page will disconnect you from the live stream",
